...
const SummaryPage: React.FC<SummaryPageProps> = ({ 
    ...
    const handleSubmitToDrive = async () => {
        ...
        const allQuestionnaires = [
            ...
            { name: 'HAD', filled: Object.values(hadAnswers).some(a=>a!==null), isComplete: true, content: () => generateHadText(hadAnswers, patientInfo) },
        ];
        ...
        const stepToQuestionnaireName: { [key in Step]?: string } = {
            ...
            objectifs: 'Objectifs', mmrc: 'mMRC', sgrq: 'SGRQ', had: 'HAD',
        };
        ...
        // FIX: Re-using the typed psfsInstances here.
            ...
            <div id="print-area">
                ...
                <section className="mb-8">
                    ...
                    {/* ... (all other details sections) ... */}
                     {/* FIX: Typed psfsInstances is used here to avoid 'unknown' errors. */}
